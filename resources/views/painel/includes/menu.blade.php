<div class="menu-painel col-md-2">
    <ul class="menu-painel-ul">
        ...
        <li>
            <a href="{{url('/painel/empreendimento')}}"><i class="fa fa-user"></i> Estabelecimentos</a>
        </li>
        
         <li>
            <a href="{{url('/painel/movimentacao')}}"><i class="fa fa-user-times"></i>Entradas</a>
        </li>
           <li>
            <a href="{{url('/painel/pdf')}}"><i class="fa fa-user"></i>Relatório</a>
        </li>
        <li>
